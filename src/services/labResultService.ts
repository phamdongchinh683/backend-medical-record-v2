...
//     try {
//       const prescription = await this.labResultRepository.create(data);
//       if (!prescription) {
...
//     try {
//       const prescription = await this.labResultRepository.update(id, data);
...
//     try {
//       const prescription = await this.labResultRepository.delete(id);
//       if (prescription.affected == 0) {
...
//   ) {
//     try {
//       const prescription = await this.labResultRepository.findByNft(
//         nftToken,
//         page,
//         limit > 100 ? 100 : limit
//       );
...
//         return;
//       }
//       responseStatus(res, "success", 200, "Prescription found successfully");
//     } catch (error) {
//       throw new Error(error.message);
//     }
//   }
